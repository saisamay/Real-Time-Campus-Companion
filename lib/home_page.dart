...
import 'emptyclassrooms_page.dart'; // CR uses this instead of emptyclassrooms_page_student.dart
    ...
    return Scaffold(
      ...
      body: PageView(
        ...
        children: [
          ...
          const EventsPage(),
          // CR VERSION: Uses emptyclassrooms_page.dart (NOT emptyclassrooms_page_student.dart)
          EmptyClassroomsPage(
